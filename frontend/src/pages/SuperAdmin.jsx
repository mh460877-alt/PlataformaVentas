                    ...
                    <div className="fixed inset-0 bg-black/90 flex items-center justify-center p-4 z-[9999] backdrop-blur-md">
                        <div className="bg-white p-8 rounded-3xl w-full max-w-md shadow-2xl">
                            ...
                            <div className="space-y-4">
                                ...
                                <div><label className="text-xs font-bold text-slate-500 uppercase">Misión y Valores</label><textarea className="w-full p-3 rounded-lg bg-white border border-slate-300 text-black mt-1 resize-none" rows={3} value={editingCompany.mission_values || ''} onChange={e => setEditingCompany({...editingCompany, mission_values: e.target.value})} /></div>
